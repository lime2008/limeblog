<script setup lang="ts">
    ...
    onMounted(()=>{
      height.value = sizeGetter('details').height + 220 + 'px';
...
<template>
    <div class="image" :style="{ backgroundImage: 'url(' + data.image + ')' , height: height}">
        <header class="details" id="details" :style="{ color : (data.style?.color ? data.style?.color : 'black')}">
