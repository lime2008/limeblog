...
const info = {
    blog : 'LIMEUWU',
    author : 'limeuwu',
    url : 'https://www.lihouse.xyz/',
    description : 'Puis-je prétendre à un miracle ',
    background :'https://cdn-community.codemao.cn/47/community/d2ViXzMwMDFfNDk3MDQ3Ml8wXzE2NzEwODc3MTQ3MTRfNWNhMDJiYTM.png',
    avatar : avatar,
    items : [
